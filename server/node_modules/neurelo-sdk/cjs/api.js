...
exports.TaskApiService = exports.TaskApi = exports.TaskApiFactory = exports.TaskApiFp = exports.TaskApiAxiosParamCreator = exports.TaskScalarFieldEnum = exports.TaskGroupByInputMinEnum = exports.TaskGroupByInputMaxEnum = exports.TaskGroupByInputCountEnum = exports.TaskAggregateInputMinEnum = exports.TaskAggregateInputMaxEnum = exports.TaskAggregateInputCountEnum = exports.SortOrder = exports.QueryMode = void 0;
...
exports.TaskAggregateInputCountEnum = {
    All: '_all',
    Id: 'id',
    Name: 'name'
};
exports.TaskAggregateInputMaxEnum = {
    Id: 'id',
    Name: 'name'
};
exports.TaskAggregateInputMinEnum = {
    Id: 'id',
    Name: 'name'
};
exports.TaskGroupByInputCountEnum = {
    All: '_all',
    Id: 'id',
    Name: 'name'
};
exports.TaskGroupByInputMaxEnum = {
    Id: 'id',
    Name: 'name'
};
exports.TaskGroupByInputMinEnum = {
    Id: 'id',
    Name: 'name'
};
/**
 ...
 * @export
 */
var TaskApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
         * Aggregate by Task
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            (0, common_1.assertParamExists)('aggregateByTask', 'select', select);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            (0, common_1.assertParamExists)('createManyTask', 'taskCreateManyInput', taskCreateManyInput);
                        ...
                        case 1:
                            ...
                            headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                            localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(taskCreateManyInput, localVarRequestOptions, configuration);
                            return [2 /*return*/, {
                                    url: (0, common_1.toPathString)(localVarUrlObj),
                                    options: localVarRequestOptions,
                                }];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            (0, common_1.assertParamExists)('createOneTask', 'taskCreateInput', taskCreateInput);
                        ...
                        case 1:
                            ...
                            headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                            localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(taskCreateInput, localVarRequestOptions, configuration);
                            return [2 /*return*/, {
                                    url: (0, common_1.toPathString)(localVarUrlObj),
                                    options: localVarRequestOptions,
                                }];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            (0, common_1.assertParamExists)('deleteTaskById', 'value', value);
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'value' is not null or undefined
                            (0, common_1.assertParamExists)('findTaskById', 'value', value);
                            localVarPath = "/rest/Task/{value}"
                                .replace("{".concat("value", "}"), String(value));
                            localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
                            if (configuration) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'select' is not null or undefined
                            (0, common_1.assertParamExists)('groupByTask', 'select', select);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            (0, common_1.assertParamExists)('updateTask', 'taskUpdateManyInput', taskUpdateManyInput);
                            localVarPath = "/rest/Task";
                            localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
                            if (configuration) {
                                baseOptions = configuration.baseOptions;
                        ...
                        case 1:
                            ...
                            headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                            localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(taskUpdateManyInput, localVarRequestOptions, configuration);
                            return [2 /*return*/, {
                                    url: (0, common_1.toPathString)(localVarUrlObj),
                                    options: localVarRequestOptions,
                                }];
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'value' is not null or undefined
                            (0, common_1.assertParamExists)('updateTaskById', 'value', value);
                            // verify required parameter 'taskUpdateInput' is not null or undefined
                            (0, common_1.assertParamExists)('updateTaskById', 'taskUpdateInput', taskUpdateInput);
                            localVarPath = "/rest/Task/{value}"
                                .replace("{".concat("value", "}"), String(value));
                            localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
                            if (configuration) {
                        ...
                        case 1:
                            ...
                            headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                            localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(taskUpdateInput, localVarRequestOptions, configuration);
                            return [2 /*return*/, {
                                    url: (0, common_1.toPathString)(localVarUrlObj),
                                    options: localVarRequestOptions,
                                }];
 ...
 * @export
 */
var TaskApiFp = function (configuration) {
    var localVarAxiosParamCreator = (0, exports.TaskApiAxiosParamCreator)(configuration);
    return {
        /**
         * Aggregate by Task
         * @param {TaskAggregateInput} select
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.aggregateByTask']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.createManyTask']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, base_1.globalAxios, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.createOneTask']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, base_1.globalAxios, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.deleteTask']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, base_1.globalAxios, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.deleteTaskById']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, base_1.globalAxios, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.findTask']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, base_1.globalAxios, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.findTaskById']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, base_1.globalAxios, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.groupByTask']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, base_1.globalAxios, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.updateTask']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, base_1.globalAxios, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['TaskApi.updateTaskById']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, base_1.globalAxios, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
 ...
 * @export
 */
var TaskApiFactory = function (configuration, basePath, axios) {
    var localVarFp = (0, exports.TaskApiFp)(configuration);
    return {
        /**
         * Aggregate by Task
         * @param {TaskAggregateInput} select
...
var TaskApi = /** @class */ (function (_super) {
    ...
    TaskApi.prototype.aggregateByTask = function (select, filter, orderBy, skip, take, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).aggregateByTask(select, filter, orderBy, skip, take, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Create multiple Task records
     * @param {Array<TaskCreateManyInput>} taskCreateManyInput
    ...
    TaskApi.prototype.createManyTask = function (taskCreateManyInput, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).createManyTask(taskCreateManyInput, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Create one Task record
     * @param {TaskCreateInput} taskCreateInput
    ...
    TaskApi.prototype.createOneTask = function (taskCreateInput, select, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).createOneTask(taskCreateInput, select, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Delete multiple Task records
     * @param {TaskWhereInput} [filter]
    ...
    TaskApi.prototype.deleteTask = function (filter, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).deleteTask(filter, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Delete one Task record by id
     * @param {string} value
    ...
    TaskApi.prototype.deleteTaskById = function (value, select, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).deleteTaskById(value, select, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Retrieve multiple Task records
     * @param {TaskSelectInput} [select]
    ...
    TaskApi.prototype.findTask = function (select, filter, orderBy, skip, take, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).findTask(select, filter, orderBy, skip, take, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Find one Task record by id
     * @param {string} value
    ...
    TaskApi.prototype.findTaskById = function (value, select, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).findTaskById(value, select, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Group by Task
     * @param {TaskGroupByInput} select
    ...
    TaskApi.prototype.groupByTask = function (select, filter, orderBy, groupBy, having, skip, take, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).groupByTask(select, filter, orderBy, groupBy, having, skip, take, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Update multiple Task records
     * @param {TaskUpdateManyInput} taskUpdateManyInput
    ...
    TaskApi.prototype.updateTask = function (taskUpdateManyInput, filter, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).updateTask(taskUpdateManyInput, filter, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     * Update one Task record by id
     * @param {string} value
    ...
    TaskApi.prototype.updateTaskById = function (value, taskUpdateInput, select, options) {
        var _this = this;
        return (0, exports.TaskApiFp)(this.configuration).updateTaskById(value, taskUpdateInput, select, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return TaskApi;
}(base_1.BaseAPI));
exports.TaskApi = TaskApi;
exports.TaskApiService = new TaskApi(configuration_1.neureloConfig);
